            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Subjects</h6>
                  <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr>
                          <th class="text-left">Name</th>
                          <th class="text-left">Added_by</th>
                          <th class="text-left">Added_At</th>
                          <!-- <th class="text-left">something here</th> -->
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-left">{{ $subject->registered_by_admin }}</td>
                          <td class="text-left">{{ $subject->created_at }}</td>
                          <!-- <td class="text-left">something here</td> -->
                          <td class="text-left">
                          	...
                          	<form method="post" action="/subjects-togglestatus" style="display: inline;">
                          	@csrf
                          	<input type="hidden" name="subjectId" value="{{ $subject->id }}">
                          	@if($subject->is_active==1)
                          	<input type="hidden" name="toggler" value="{{ $subject->is_active }}">
                ...
                <div class="mdc-card">
                  ...
                  <div class="template-demo">
                    <div class="mdc-layout-grid__inner">
                      ...
                      <form action="/subjects/new" method="post">
                      	@csrf
